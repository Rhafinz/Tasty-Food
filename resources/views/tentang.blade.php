        ...
        <div class="container container-about mt-5">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 d-flex justify-content-center mb-4">
                    <img src="{{ asset('assets/ASET/fathul-abrar-T-qI_MI2EMA-unsplash.jpg') }}" alt="Visi Image 1"
                        class="img-fluid rounded-image1 me-2">
                    <img src="{{ asset('assets/ASET/michele-blackwell-rAyCBQTH7ws-unsplash.jpg') }}" alt="Visi Image 2"
